...
| P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE | PASS | 2026-05-18 | STEP 6 complete — falsification-enabled checkpoint (l_falsification=1.0, stage2 500 steps). C4=0.824 first unlocked. C3_f1=0.0 (degenerate — root cause diagnosed as planner._effect_type_id mapping bug, fix deferred to STEP 7). ABL-016 control registered. 14 CRITICAL ablations in ABLATION_REGISTRY. sentinel P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE.passed created. |
| P3_STEP7_FULL_EVIDENCE_VALIDATION | PASS | 2026-05-18 | STEP 7 complete — C3 root-cause code fix (planner+losses+lr_scorer, 29 new tests GREEN). Task 2 Option C (short-circuit {0,6} unchanged). C2 ood_shift_f1 proxy (MET-OOD-003 STEP 7) + C5 calibration retest stub. C4 expanded validation harness (5 seeds). 11 inference-time ablation harness + ABL-040 isolation. BASE-026/027 approximation_level unified. fake_metric_count=0, leakage PASS. regression suite GREEN. STEP 8 handoff doc created. sentinel P3_STEP7_FULL_EVIDENCE_VALIDATION.passed created. |
| P3_STEP8_FINAL_EVIDENCE_VALIDATION | PASS | 2026-05-18 | STEP 8 complete — v0_4 5000ep dataset (OOD PASS: blocker_removed=50, delayed_effect=50). Stage A/B long-horizon training (l_falsification=0.635 non-zero). 8 Codex tasks merged (1087-1095). C6 progress_per_compute gap: FRCG-LR 0.221 vs ABL-036 0.015 (93%). C3 PRELIMINARY_PENDING_EVAL (F_t variance=0.191, eval threshold fix needed STEP 9). C4 task_success NON_DISCRIMINATIVE (ceiling 0.994-0.998). ABL-015 faithful retrain done. BASE-026/027 WACFaithfulCandidate + CUWMFaithfulCandidate (approximation_level=partial, forbidden_wording=0). 12 inference ablations + ABL-040 isolated. fake_metric_count=0, leakage=0. 606 tests pass (+25 new). Verdict: AT_RISK MEDIUM. sentinel P3_STEP8_FINAL_EVIDENCE_VALIDATION.passed created. |
| P3_STEP9_C3_RECOVERY | PASS | 2026-05-18 | STEP 9 C3 Recovery Loop complete — AT_RISK_BUT_RECOVERING verdict. C3 0.0→0.539/0.587 (test_id/test_ood, n=5 deterministic). 6 surgical fixes: tau_f 0.5→0.0, no_state_change proxy evidence (type 3), planner_state.update(), ABL-040 activation, success fix. TASK_1096: EvaluationLabels.true_regime + regime_shift_f1 (Codex). TASK_1097: ABL-001/003 faithful retrain configs (Codex). Direct-threat baselines (BASE-026/027/028): C3=0.0, ppc 5.5-8.6× below FRCG-LR. C2=0.0 (v0_4 no intra-episode regime shifts — data limitation). ABL-040 recall=1.000 (positive control ACTIVE). C6 14.9× vs ABL-036. fake_metric_count=0, leakage=0. Gate O-39/40/C3/DTB PASS. ABL-001/003 retrain pending (STEP 10). sentinel P3_STEP9_C3_RECOVERY.passed created. |
| P_CLEANUP_2026_05_22 | PASS | 2026-05-22 | Repository cleanup + Core Theory SSoT. B-0 pre-flight commit. core_theory_ssot.md (≤330 lines, 10 sections). 00_CONTEXT_INDEX.md §3+§6.5 updated. 05_*.md DEPRECATED banner. GUI code purged: 13 files + configs/data_collection_gui_mve.yaml. screenshot_ref removed from PublicObservation + all src/tests/scripts refs (11+2 files). B-2: 57 dated report files deleted. B-8: codex-work fast-forwarded to HEAD. Checklist: 57/60 PASS (C3.1/C3.7 gitignored, C2.1=17 actual vs 16 plan). pytest: 3 pre-existing failures unchanged, 0 new regressions. sentinel P_CLEANUP_2026_05_22.passed created. |
...
- 2026-05-18T13:10:43Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY | SoT: docs/orchestration/session_reports/2026-05/2026-05-18_precompact_handoff.md
- 2026-05-18T14:26:26Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE | SoT: docs/orchestration/session_reports/2026-05/2026-05-18_precompact_handoff.md
- 2026-05-18T16:26:35Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE, P3_STEP7_FULL_EVIDENCE_VALIDATION | SoT: docs/orchestration/session_reports/2026-05/2026-05-18_precompact_handoff.md
- 2026-05-18T19:43:06Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE, P3_STEP7_FULL_EVIDENCE_VALIDATION, P3_STEP8_FINAL_EVIDENCE_VALIDATION | SoT: docs/orchestration/session_reports/2026-05/2026-05-18_precompact_handoff.md
- 2026-05-18T21:25:39Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE, P3_STEP7_FULL_EVIDENCE_VALIDATION, P3_STEP8_FINAL_EVIDENCE_VALIDATION, P3_STEP9_C3_RECOVERY | SoT: docs/orchestration/session_reports/2026-05/2026-05-18_precompact_handoff.md
- 2026-05-19T09:57:43Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE, P3_STEP7_FULL_EVIDENCE_VALIDATION, P3_STEP8_FINAL_EVIDENCE_VALIDATION, P3_STEP9_C3_RECOVERY | SoT: docs/orchestration/session_reports/2026-05/2026-05-19_precompact_handoff.md
- 2026-05-19T12:52:14Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE, P3_STEP7_FULL_EVIDENCE_VALIDATION, P3_STEP8_FINAL_EVIDENCE_VALIDATION, P3_STEP9_C3_RECOVERY | SoT: docs/orchestration/session_reports/2026-05/2026-05-19_precompact_handoff.md
- 2026-05-19T14:44:13Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE, P3_STEP7_FULL_EVIDENCE_VALIDATION, P3_STEP8_FINAL_EVIDENCE_VALIDATION, P3_STEP9_C3_RECOVERY | SoT: docs/orchestration/session_reports/2026-05/2026-05-19_precompact_handoff.md
- 2026-05-22T13:38:28Z | branch: memory-redesign-2026-05-16 | passed_gates: P1.5, P1, P2, P3, P3_EVAL, P3_LR_EVAL, P3_LR_REAL_EVAL, P3_STEP3_DATASET_BACKFILL, P3_STEP4_EVIDENCE_INTEGRITY, P3_STEP5_TRAINED_EVIDENCE_READY, P3_STEP6_FALSIFICATION_ENABLED_EVIDENCE, P3_STEP7_FULL_EVIDENCE_VALIDATION, P3_STEP8_FINAL_EVIDENCE_VALIDATION, P3_STEP9_C3_RECOVERY, P_CLEANUP_2026_05_22 | SoT: docs/orchestration/session_reports/2026-05/2026-05-22_precompact_handoff.md
